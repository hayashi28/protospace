...
describe Prototype do
  describe 'with comments' do
    ...
    it "deletes the comments when prototype is deleted" do
      comment = FactoryGirl.create(:comment, prototype: prototype)
  ...
  describe 'with likes' do
    it 'deletes the likes when Prototype is deleted' do
      ...
      like = FactoryGirl.create(:like, prototype: prototype)
  ...
  describe '#liked_by?(user)' do
    ...
    describe 'when not liked by a user' do
      it 'returns nill' do
        user = FactoryGirl.create(:user, nickname: 'aaa')
        like = FactoryGirl.create(:like, user_id: 'nil')
